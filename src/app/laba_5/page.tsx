...
const WirelessLabAll = () => {
    useEffect(() => {
        document.title = "Лабораторная работа №5";
    ...
    return (
        <div style={styles.root}>
            ...
            <ol style={styles.ol}>
                <li style={styles.li}>
                    <b>Потери в свободном пространстве для 802.11n (7 канал, 2442 МГц, 100 м):</b>
                    <div style={styles.answer}>{lbf1.toFixed(2)} дБ</div>
                </li>
                <li style={styles.li}>
                    <b>
                        Потери в свободном пространстве для 802.11n–802.11ac (64 канал, 5320 МГц,
                        200 м):
                    </b>
                    <div style={styles.answer}>{lbf2.toFixed(2)} дБ</div>
                </li>
                <li style={styles.li}>
                    <b>
                        Радиус первой зоны Френеля (расстояние 15 км, S1 = 7 км, частота 2,437 ГГц):
                    </b>
                    <div style={styles.answer}>{R3.toFixed(2)} м</div>
                </li>
                <li style={styles.li}>
                    <b>Минимальная высота установки антенн (80% зоны; 4 км; 5,48 ГГц):</b>
                    <div style={styles.answer}>{H4.toFixed(2)} м</div>
                </li>
                <li style={styles.li}>
                    <b>Макс. расстояние для DAP-2310 и DWA-160 при 300 Мбит/с:</b>
                    <div style={styles.answer}>{D5_300.toFixed(2)} км</div>
                    <b>при 1 Мбит/с:</b>
                    <div style={styles.answer}>{D5_1.toFixed(2)} км</div>
                </li>
                <li style={styles.li}>
                    <b>Макс. расстояние для DAP-2660 и DWA-182 на максимальной скорости (5 ГГц):</b>
                    <div style={styles.answer}>{D6.toFixed(2)} км</div>
                </li>
                <li style={styles.li}>
                    <b>
                    ...
                    <div>
                        DAP-3662 → DWA-182: уровень сигнала{" "}
                        <span style={styles.answer}>{Pr7_1.toFixed(2)} дБм</span>
                    </div>
                    <div>
                        DWA-182 → DAP-3662: уровень сигнала{" "}
                        <span style={styles.answer}>{Pr7_2.toFixed(2)} дБм</span>
                    </div>
